...
const BACKEND_SCHEMA: Record<string, string[]> = {
  ...
  aiGetEventGuestStats: ['going', 'not_going', 'pending', 'total', 'checkins', 'total_tickets_sold', 'total_revenue', 'pending_approval', 'pending_invite', 'declined', 'checked_in', 'ticket_types', 'ticket_type', 'ticket_type_title', 'guests_count'],
  ...
  getEventGuestsStatistics: ['going', 'pending_approval', 'pending_invite', 'declined', 'checked_in', 'ticket_types', 'ticket_type', 'ticket_type_title', 'guests_count'],
  ...
  getEventPaymentStatistics: ['total_payments', 'stripe_payments', 'revenue', 'currency', 'formatted_total_amount', 'count', 'crypto_payments', 'networks', 'chain_id'],
