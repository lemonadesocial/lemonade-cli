...
const BACKEND_SCHEMA: Record<string, string[]> = {
  ...
  aiCreateEvent: ['_id', 'title', 'shortid', 'start', 'end', 'published', 'description', 'address', 'city', 'country', 'latitude', 'longitude'],
  aiUpdateEvent: ['_id', 'title', 'shortid', 'start', 'end', 'published', 'description', 'address', 'city', 'country', 'latitude', 'longitude'],
  ...
  updateEvent: ['_id', 'title', 'shortid', 'start', 'end', 'published', 'virtual', 'virtual_url', 'private', 'guest_limit', 'guest_limit_per', 'timezone', 'approval_required'],
