...
const BACKEND_SCHEMA: Record<string, string[]> = {
  ...
  getEventFeedbackSummary: ['rates', 'rate_value', 'count'],
  listEventFeedBacks: ['user', 'email', 'event', 'rate_value', 'comment', 'created_at', 'user_info', '_id', 'name', 'image_avatar'],
  ...
  listEventGuests: ['total', 'items', '_id', 'user', 'email', 'state', 'user_expanded', 'name', 'display_name', 'image_avatar', 'created_at', 'ticket', 'type', 'type_expanded', 'title', 'checkin', 'join_request', 'payment', 'application'],
