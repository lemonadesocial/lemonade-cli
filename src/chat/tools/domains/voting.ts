...
export const votingTools: CanonicalCapability[] = [
  buildCapability({
    ...
    whenToUse: 'when user wants to see voting sessions',
    searchHint: 'votings polls sessions event audience',
    shouldDefer: true,
    destructive: false,
    backendType: 'query',
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants to cast or change a vote',
    searchHint: 'vote cast poll choose option select',
    shouldDefer: true,
    destructive: true,
