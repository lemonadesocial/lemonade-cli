...
export const spaceTools: CanonicalCapability[] = [
  buildCapability({
    ...
    whenToUse: 'to set up a new community or organization space',
    searchHint: 'create new community space organization group establish',
    alwaysLoad: true,
    destructive: false,
  ...
  buildCapability({
    ...
    whenToUse: 'to list all communities the user owns or belongs to',
    searchHint: 'list communities spaces groups organizations membership',
    alwaysLoad: true,
    destructive: false,
    backendType: 'query',
  ...
  buildCapability({
    ...
    whenToUse: 'to change a community\'s name, description, branding, or settings',
    searchHint: 'update edit space community settings configure branding',
    alwaysLoad: true,
    destructive: false,
    backendType: 'mutation',
