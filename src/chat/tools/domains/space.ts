...
export const spaceTools: CanonicalCapability[] = [
  buildCapability({
    ...
    whenToUse: 'when user wants to create a new community',
    searchHint: 'create new community space organization group',
    alwaysLoad: true,
    destructive: false,
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants to see their communities',
    searchHint: 'list communities spaces groups my organizations',
    alwaysLoad: true,
    destructive: false,
    backendType: 'query',
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants to switch active community context',
    searchHint: 'switch change active space community context',
    shouldDefer: true,
    destructive: false,
    backendType: 'query',
    backendResolver: 'aiListMySpaces',
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants to edit community settings',
    searchHint: 'update edit space community settings profile',
    alwaysLoad: true,
    destructive: false,
    backendType: 'mutation',
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants community overview statistics',
    searchHint: 'stats overview space community analytics summary',
    alwaysLoad: true,
    destructive: false,
    backendType: 'query',
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants to see community members',
    searchHint: 'members list people community users roles',
    alwaysLoad: true,
    destructive: false,
    backendType: 'query',
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants to see space integrations status',
    searchHint: 'connectors integrations space connected platforms',
    shouldDefer: true,
    destructive: false,
    backendType: 'query',
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants to connect Stripe to a community',
    searchHint: 'stripe connect space payments setup onboard',
    shouldDefer: true,
    destructive: false,
    backendType: 'mutation',
  ...
  buildCapability({
    ...
    params: [],
    whenToUse: 'when user wants to check Stripe connection status',
    searchHint: 'stripe status connected space payments check',
    shouldDefer: true,
    destructive: false,
    backendType: 'query',
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants to delete a community',
    searchHint: 'delete remove space community permanent destroy',
    shouldDefer: true,
    destructive: true,
    backendType: 'mutation',
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants detailed community analytics',
    searchHint: 'deep stats analytics detailed space community',
    shouldDefer: true,
    destructive: false,
    backendType: 'query',
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants to see top event hosts in community',
    searchHint: 'top hosts leaderboard organizers active space',
    shouldDefer: true,
    destructive: false,
    backendType: 'query',
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants member activity leaderboard',
    searchHint: 'member leaderboard ranking active engagement',
    shouldDefer: true,
    destructive: false,
    backendType: 'query',
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants community event activity insights',
    searchHint: 'events insight community activity analytics trend',
    shouldDefer: true,
    destructive: false,
    backendType: 'query',
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants to change a member role',
    searchHint: 'update member role permissions admin host',
    shouldDefer: true,
    destructive: false,
    backendType: 'mutation',
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants to pin an event in the community',
    searchHint: 'pin event featured highlight space top',
    shouldDefer: true,
    destructive: false,
    backendType: 'mutation',
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants to unpin an event',
    searchHint: 'unpin event remove featured highlight',
    shouldDefer: true,
    destructive: false,
    backendType: 'mutation',
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants to see community member tags',
    searchHint: 'tags list labels categories members groups',
    shouldDefer: true,
    destructive: false,
    backendType: 'query',
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants to create or update a member tag',
    searchHint: 'create update tag label category member',
    shouldDefer: true,
    destructive: false,
    backendType: 'mutation',
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants to delete a member tag',
    searchHint: 'delete remove tag label category member',
    shouldDefer: true,
    destructive: true,
    backendType: 'mutation',
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants to assign or remove tags from members',
    searchHint: 'manage assign tags members add remove label',
    shouldDefer: true,
    destructive: false,
    backendType: 'mutation',
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants to see event hosting requests',
    searchHint: 'event requests pending hosting proposals space',
    shouldDefer: true,
    destructive: false,
    backendType: 'query',
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants to approve or reject event requests',
    searchHint: 'decide approve reject event requests hosting',
    shouldDefer: true,
    destructive: true,
    backendType: 'mutation',
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants a summary of space events',
    searchHint: 'event summary space overview total stats',
    shouldDefer: true,
    destructive: false,
    backendType: 'query',
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants to check email sending limits',
    searchHint: 'sending quota email limits capacity remaining',
    shouldDefer: true,
    destructive: false,
    backendType: 'query',
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants to see their own event requests',
    searchHint: 'my event requests submitted pending status',
    shouldDefer: true,
    destructive: false,
    backendType: 'query',
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants to see role permission settings',
    searchHint: 'role features permissions access control settings',
    shouldDefer: true,
    destructive: false,
    backendType: 'query',
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants to update role permissions',
    searchHint: 'update role features permissions access modify',
    shouldDefer: true,
    destructive: true,
    backendType: 'mutation',
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants member growth chart data',
    searchHint: 'member growth chart trend new signups',
    shouldDefer: true,
    destructive: false,
    backendType: 'query',
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants to see most active attendees',
    searchHint: 'top attendees active engaged frequent community',
    shouldDefer: true,
    destructive: false,
    backendType: 'query',
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants geographic member distribution',
    searchHint: 'location leaderboard geography cities members map',
    shouldDefer: true,
    destructive: false,
    backendType: 'query',
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants community reward program stats',
    searchHint: 'reward stats cashback earnings community space',
    shouldDefer: true,
    destructive: false,
    backendType: 'query',
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants to set community avatar image',
    searchHint: 'set avatar profile picture space community image',
    shouldDefer: true,
    destructive: true,
    backendType: 'mutation',
    backendResolver: 'updateSpace',
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants to set community cover image',
    searchHint: 'set cover banner image space community photo',
    shouldDefer: true,
    destructive: true,
    backendType: 'mutation',
    backendResolver: 'updateSpace',
