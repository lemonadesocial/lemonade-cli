...
export const userTools: CanonicalCapability[] = [
  buildCapability({
    ...
    params: [],
    whenToUse: 'to check the authenticated user\'s profile and identity',
    searchHint: 'whoami profile me authenticated identity account',
    alwaysLoad: true,
    destructive: false,
    backendType: 'query',
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants to edit their profile',
    searchHint: 'update edit profile name bio social handles',
    destructive: false,
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants to find someone by name or email',
    searchHint: 'search find user people lookup email name',
    destructive: false,
    backendType: 'query',
