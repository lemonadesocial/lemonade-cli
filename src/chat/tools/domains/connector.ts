...
export const connectorTools: CanonicalCapability[] = [
  buildCapability({
    ...
    params: [],
    whenToUse: 'to see which third-party platform integrations are available',
    searchHint: 'integrations platforms connectors supported list',
    alwaysLoad: true,
    destructive: false,
    backendType: 'query',
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants to trigger an integration sync',
    searchHint: 'sync trigger connector refresh pull',
    destructive: false,
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants to connect a new integration',
    searchHint: 'connect integration oauth setup link',
    destructive: false,
    backendType: 'mutation',
  ...
  buildCapability({
    ...
    whenToUse: 'when user needs to provide an API key for a connector',
    searchHint: 'api key submit connector authenticate',
    destructive: false,
    backendType: 'mutation',
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants to configure connector settings',
    searchHint: 'configure settings connector schedule options',
    destructive: false,
    backendType: 'mutation',
  ...
  buildCapability({
    ...
    whenToUse: 'when user needs dropdown options for connector config',
    searchHint: 'connector options dropdown config choices',
    destructive: false,
    backendType: 'query',
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants to see connector sync history',
    searchHint: 'connector logs sync history activity',
    destructive: false,
    backendType: 'query',
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants to remove an integration',
    searchHint: 'disconnect remove integration revoke',
    destructive: true,
    backendType: 'mutation',
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants to check connector slot availability',
    searchHint: 'connector slots limit capacity tier',
    destructive: false,
    backendType: 'query',
