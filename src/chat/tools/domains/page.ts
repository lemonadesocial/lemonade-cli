...
export const pageTools: CanonicalCapability[] = [
  buildCapability({
    ...
    whenToUse: 'when user wants to AI-generate a page from a description',
    searchHint: 'generate page ai website landing description',
    alwaysLoad: true,
    destructive: false,
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants to create a page with AI help',
    searchHint: 'create page website landing ai assisted',
    alwaysLoad: true,
    destructive: false,
    backendType: 'mutation',
