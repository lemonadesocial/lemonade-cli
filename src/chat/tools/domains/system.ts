...
export const systemTools: CanonicalCapability[] = [
  buildCapability({
    ...
    params: [],
    whenToUse: 'when user wants to check the API version',
    searchHint: 'backend version api status health check',
    alwaysLoad: true,
    destructive: false,
    backendType: 'query',
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants to check AI credit balance',
    searchHint: 'credits balance remaining ai usage quota',
    alwaysLoad: true,
    destructive: false,
    backendType: 'query',
