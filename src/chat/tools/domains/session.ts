...
export const sessionTools: CanonicalCapability[] = [
  buildCapability({
    ...
    whenToUse: 'when user wants to see session reservations',
    searchHint: 'session reservations bookings schedule slots',
    shouldDefer: true,
    destructive: false,
    backendType: 'query',
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants session reservation counts',
    searchHint: 'session reservation summary counts capacity',
    shouldDefer: true,
    destructive: false,
    backendType: 'query',
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants to reserve a session spot',
    searchHint: 'reserve book session spot slot signup',
    shouldDefer: true,
    destructive: false,
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants to cancel a session reservation',
    searchHint: 'cancel unreserve session booking release',
    shouldDefer: true,
    destructive: true,
    backendType: 'mutation',
