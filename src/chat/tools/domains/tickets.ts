...
export const ticketsTools: CanonicalCapability[] = [
  buildCapability({
    ...
    whenToUse: 'when user wants to see ticket types for an event',
    searchHint: 'tickets types list event pricing tiers',
    alwaysLoad: true,
    destructive: false,
    backendType: 'query',
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants to create a new ticket type',
    searchHint: 'create ticket type pricing tier new',
    alwaysLoad: true,
    destructive: false,
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants to purchase event tickets',
    searchHint: 'buy purchase tickets attend register event',
    alwaysLoad: true,
    destructive: true,
