...
export const eventTools: CanonicalCapability[] = [
  buildCapability({
    ...
    whenToUse: 'when user wants to create a new event',
    searchHint: 'create new event planning schedule host',
    alwaysLoad: true,
    destructive: false,
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants to see their hosted events',
    searchHint: 'list show events hosting upcoming my',
    alwaysLoad: true,
    destructive: false,
    backendType: 'query',
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants to find events across platforms',
    searchHint: 'search find discover events nearby explore',
    shouldDefer: true,
    destructive: false,
    backendType: 'query',
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants details about a specific event',
    searchHint: 'get details info event specific view',
    alwaysLoad: true,
    destructive: false,
    backendType: 'query',
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants to modify event details',
    searchHint: 'update edit modify change event settings',
    alwaysLoad: true,
    destructive: false,
    backendType: 'mutation',
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants to make an event live',
    searchHint: 'publish launch go live event activate',
    alwaysLoad: true,
    destructive: false,
    backendType: 'mutation',
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants to cancel an event',
    searchHint: 'cancel abort stop event remove',
    alwaysLoad: true,
    destructive: true,
    backendType: 'mutation',
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants guest attendance statistics',
    searchHint: 'guest stats attendance rsvp count summary',
    alwaysLoad: true,
    destructive: false,
    backendType: 'query',
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants to see event guest list',
    searchHint: 'guests attendees list who registered',
    alwaysLoad: true,
    destructive: false,
    backendType: 'query',
  ...
  buildCapability({
    ...
    whenToUse: 'when user wants to see who checked in',
    searchHint: 'checkins checked in arrivals attendance',
    alwaysLoad: true,
    destructive: false,
    backendType: 'query',
